    ...
    <Card>
      <CardContent className="p-4">
        <div className="flex items-start justify-between gap-2 flex-wrap">
          ...
          <div className={`flex items-center justify-center w-9 h-9 rounded-md ${accentClass || "bg-primary/10"}`}>
            <Icon className={`w-4 h-4 ${accentClass ? "text-primary-foreground" : "text-primary"}`} />
          </div>
        </div>
      </CardContent>
    </Card>
                ...
                <Link key={trip.id} href={`/trips/${trip.id}`}>
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      <div className={`flex items-center justify-center w-8 h-8 rounded-md ${trip.tripType === "business" ? "bg-primary/10" : "bg-chart-3/10"}`}>
